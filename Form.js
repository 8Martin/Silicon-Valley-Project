class Form{
  ...
  constructor() {
    ...
    this.enterButton = createButton("ENTER THE SHIP");
    // IN LEVEL - 2 //
  ...
  setElementsPosition() {   
    ...
    this.enterButton.position(width / 2 + 24000, height / 2 - 50);
    //FOR OPENING LINKS //
  ...
  setElementsStyle() {
    ...
    this.enterButton.class("customButton_3");
    //FOR OPENING LINKS //
 ...
 handleMousePressed(){
  ...
  //FOR OPENING LINKS //
   ...
   if(cube === 10){ 
    ...
    this.go1Button.mousePressed(()=>{
      swal("ALERT!", "If you get hit three times GAME OVER", "warning");
      gameState = "serve";
  ...
  Rules(){
    swal({
      title: `Rules!`,
      text: "Press Left and Right Arrow key to control Wall-e",
      imageUrl:
